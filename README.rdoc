...
NOTE: There is no need to put the full path, just translate each slug individually.
...
NOTE: Since each app may work differently, there is no default logic to select the current locale.

Here it's a simple example of what you may want to add to your controllers to select the current locale:
